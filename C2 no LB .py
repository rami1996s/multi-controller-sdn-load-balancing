# controller2_noLB.py (Modified for 3-controller architecture)
...
class MemoryOptimizedController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.last_migration_time = {}  # Not used in no-LB version, kept for consistency
    ...
    def _monitor(self):
        ...
        log_file = "/tmp/kpi_log_c2_noLB.csv"
        ...
        while True:
            ...
            if valid_peers:
                ...
                if score > min_peer_score and score_diff > 7:
                    self.logger.info("[C2] Migration condition met, but load balancing is DISABLED for this test.")
