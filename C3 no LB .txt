...
class C3NoLoadBalancingController(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(C3NoLoadBalancingController, self).__init__(*args, **kwargs)
    ...
    def _monitor(self):
        ...
        log_file = "/tmp/kpi_log_c3_noLB.csv"
        ...
        while True:
            ...
            with self.lock:
                ...
                self.current_cpu = process.cpu_percent()      # per-process CPU
                self.current_mem = process.memory_percent()   # per-process RAM
            ...
            if valid_peers:
                ...
                if score > min_peer_score and score_diff > 7:
                    self.logger.info("[C3] Migration condition met, but load balancing is DISABLED for this test.")
